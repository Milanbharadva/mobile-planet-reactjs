...
const HomeAbout = () => {
  ...
  return (
    <div className="flex gap-10 lg:gap-0 mx-8 sm:mx-12 lg:mx-32 flex-col lg:flex-row mt-24">
      <div className="lg:w-[50%]">
        <img
          src={`${window.location.origin}/assets/about.jpg`}
      ...
      <div className="flex flex-col space-y-2 lg:ml-14 justify-center lg:w-[50%]">
        ...
        <div className="mt-14">
            <button onClick={()=>{navigate("/about")}} className="buttons">Know More</button>
        </div>
      </div>
    </div>
  );
